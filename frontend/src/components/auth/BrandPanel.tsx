...
export default function BrandPanel() {
  return (
    <aside className="flex min-h-[620px] flex-col justify-between bg-slate-50 p-8 text-slate-950 dark:bg-[#151515] dark:text-slate-100 lg:p-10">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">Smart Transport Operations Platform</p>
      ...
      <p className="text-xs text-slate-500 dark:text-slate-500">TransitOps © 2026 · RBAC enabled</p>
    </aside>
  );
}
